...
# ADD LINK32 /nologo /subsystem:console /machine:I386 /out:"multiple.exe"

!ELSEIF  "$(CFG)" == "multiple - Win32 Debug"
...
# ADD LINK32 /nologo /subsystem:console /debug /machine:I386 /out:"multiple.exe" /pdbtype:sept
