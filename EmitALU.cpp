...
void Emit_ABS(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  {
    vars->mpe->nativeCodeCache.X86Emit_MOVRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ebp);
    vars->mpe->nativeCodeCache.X86Emit_SHRIR(x86Reg::x86Reg_ebx, 30);
    vars->mpe->nativeCodeCache.X86Emit_ANDIR(CC_ALU_CARRY, x86Reg::x86Reg_ebx);
  ...
  if(vars->miscRegOutDep & (DEPENDENCY_FLAG_N | DEPENDENCY_FLAG_V))
  {
    ...
    {
      vars->mpe->nativeCodeCache.X86Emit_XORRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ebx);
      vars->mpe->nativeCodeCache.X86Emit_MOVIR(CC_ALU_NEGATIVE, x86Reg::x86Reg_ecx);
      vars->mpe->nativeCodeCache.X86Emit_CMPIR(0x80000000, x86Reg::x86Reg_ebp);
    ...
    {
      vars->mpe->nativeCodeCache.X86Emit_XORRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ebx);
      vars->mpe->nativeCodeCache.X86Emit_MOVIR(CC_ALU_OVERFLOW, x86Reg::x86Reg_ecx);
      vars->mpe->nativeCodeCache.X86Emit_CMPIR(0x80000000, x86Reg::x86Reg_ebp);
      vars->mpe->nativeCodeCache.X86Emit_CMOVZRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ecx);
      vars->mpe->nativeCodeCache.X86Emit_ORRR(x86Reg::x86Reg_eax, x86Reg::x86Reg_ebx);
    }
    ...
    {
      vars->mpe->nativeCodeCache.X86Emit_XORRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ebx);
      vars->mpe->nativeCodeCache.X86Emit_MOVIR(CC_ALU_NEGATIVE|CC_ALU_OVERFLOW, x86Reg::x86Reg_ecx);
      vars->mpe->nativeCodeCache.X86Emit_CMPIR(0x80000000, x86Reg::x86Reg_ebp);
      vars->mpe->nativeCodeCache.X86Emit_CMOVZRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ecx);
      vars->mpe->nativeCodeCache.X86Emit_ORRR(x86Reg::x86Reg_eax, x86Reg::x86Reg_ebx);
    }
  ...
  {
    vars->mpe->nativeCodeCache.X86Emit_XORRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ebx);
    vars->mpe->nativeCodeCache.X86Emit_MOVIR(CC_ALU_ZERO, x86Reg::x86Reg_ecx);
    vars->mpe->nativeCodeCache.X86Emit_TESTRR(x86Reg::x86Reg_ebp, x86Reg::x86Reg_ebp);
    vars->mpe->nativeCodeCache.X86Emit_CMOVZRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ecx);
    vars->mpe->nativeCodeCache.X86Emit_ORRR(x86Reg::x86Reg_eax, x86Reg::x86Reg_ebx);
  }
...
void Emit_BITSScalar(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ecx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_MOVIR(src1Imm, x86Reg::x86Reg_ebx);
  vars->mpe->nativeCodeCache.X86Emit_ANDIR(0x1F, x86Reg::x86Reg_ecx);
  vars->mpe->nativeCodeCache.X86Emit_SHRRR(x86Reg::x86Reg_eax);
  vars->mpe->nativeCodeCache.X86Emit_ANDRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_eax);
  ...
  {
    vars->mpe->nativeCodeCache.X86Emit_XORRR(x86Reg::x86Reg_eax, x86Reg::x86Reg_eax);
    vars->mpe->nativeCodeCache.X86Emit_ANDIM(~(FLAG_DEPENDENCIES(vars->miscRegOutDep & DEPENDENCY_FLAG_NZ)), x86MemPtr::x86MemPtr_dword, ccRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, ccRegDisp);
  }

  if(vars->miscRegOutDep & DEPENDENCY_FLAG_N)
  {
    vars->mpe->nativeCodeCache.X86Emit_MOVRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_ebx);
    vars->mpe->nativeCodeCache.X86Emit_SHRIR(x86Reg::x86Reg_ecx, 28);
    vars->mpe->nativeCodeCache.X86Emit_ANDIR(CC_ALU_NEGATIVE, x86Reg::x86Reg_ecx);
  ...
  if(vars->miscRegOutDep & DEPENDENCY_FLAG_Z)
  {
    ...
    vars->mpe->nativeCodeCache.X86Emit_MOVIR(CC_ALU_ZERO, x86Reg::x86Reg_edx);
...
void Emit_BTST(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_ANDIR(mask, x86Reg::x86Reg_ebx);

  if(vars->miscRegOutDep & DEPENDENCY_FLAG_NVZ)
  {
    vars->mpe->nativeCodeCache.X86Emit_XORRR(x86Reg::x86Reg_eax, x86Reg::x86Reg_eax);
    vars->mpe->nativeCodeCache.X86Emit_ANDIM(~(FLAG_DEPENDENCIES(vars->miscRegOutDep & DEPENDENCY_FLAG_NVZ)), x86MemPtr::x86MemPtr_dword, ccRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, ccRegDisp);
  }
...
void Emit_BUTT(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  {
    vars->mpe->nativeCodeCache.X86Emit_MOVRR(x86Reg::x86Reg_eax, x86Reg::x86Reg_ebx);
    vars->mpe->nativeCodeCache.X86Emit_SUBMR(x86Reg::x86Reg_eax, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
    vars->mpe->nativeCodeCache.X86Emit_MOVRM(x86Reg::x86Reg_eax, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp+4);
  }

  vars->mpe->nativeCodeCache.X86Emit_ADDMR(x86Reg::x86Reg_ebx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
  ...
  if(vars->miscRegOutDep & DEPENDENCY_FLAG_NVCZ)
  {
    if(vars->miscRegOutDep & DEPENDENCY_FLAG_N)
    {
      vars->mpe->nativeCodeCache.X86Emit_SETSR(x86Reg::x86Reg_ch);
    }

    if(vars->miscRegOutDep & DEPENDENCY_FLAG_V)
    {
      vars->mpe->nativeCodeCache.X86Emit_SETOR(x86Reg::x86Reg_cl);
    }
    
    if(vars->miscRegOutDep & DEPENDENCY_FLAG_C)
    {
      vars->mpe->nativeCodeCache.X86Emit_SETBR(x86Reg::x86Reg_dh);
    }
  ...
  if(vars->miscRegOutDep & DEPENDENCY_FLAG_N)
  {
    vars->mpe->nativeCodeCache.X86Emit_SHLIR(x86Reg::x86Reg_ch, 3);
    vars->mpe->nativeCodeCache.X86Emit_ORRR(x86Reg::x86Reg_al, x86Reg::x86Reg_ch);
  }

  if(vars->miscRegOutDep & DEPENDENCY_FLAG_V)
  {
    vars->mpe->nativeCodeCache.X86Emit_SHLIR(x86Reg::x86Reg_cl, 2);
    vars->mpe->nativeCodeCache.X86Emit_ORRR(x86Reg::x86Reg_al, x86Reg::x86Reg_cl);
  }

  if(vars->miscRegOutDep & DEPENDENCY_FLAG_C)
  {
    vars->mpe->nativeCodeCache.X86Emit_SHLIR(x86Reg::x86Reg_dh, 1);
...
void Emit_MSB(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  {
    vars->mpe->nativeCodeCache.X86Emit_XORRR(x86Reg::x86Reg_eax, x86Reg::x86Reg_eax);
    vars->mpe->nativeCodeCache.X86Emit_ANDIM(~CC_ALU_ZERO, x86MemPtr::x86MemPtr_dword, ccRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, ccRegDisp);
    vars->mpe->nativeCodeCache.X86Emit_XORRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_ecx);
    vars->mpe->nativeCodeCache.X86Emit_MOVIR(CC_ALU_ZERO, x86Reg::x86Reg_edx);
    vars->mpe->nativeCodeCache.X86Emit_TESTRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ebx);
    vars->mpe->nativeCodeCache.X86Emit_CMOVZRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_edx);
...
void Emit_SAT(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_MOVIR(mask, x86Reg::x86Reg_eax);
  vars->mpe->nativeCodeCache.X86Emit_CMPRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_eax);
  vars->mpe->nativeCodeCache.X86Emit_CMOVNLERR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_eax);
  vars->mpe->nativeCodeCache.X86Emit_NOTR(x86Reg::x86Reg_eax);
  vars->mpe->nativeCodeCache.X86Emit_CMPRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_eax);
  vars->mpe->nativeCodeCache.X86Emit_CMOVLRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_eax);
...
void Emit_ADD_SV(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  {
    vars->mpe->nativeCodeCache.X86Emit_MOVQMR(x86Reg::x86Reg_mm4, (uint32)sub_sv_mask);
    vars->mpe->nativeCodeCache.X86Emit_MOVQMR(x86Reg::x86Reg_mm0, src2RegReadBaseReg_0, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
    vars->mpe->nativeCodeCache.X86Emit_MOVQMR(x86Reg::x86Reg_mm1, src1RegReadBaseReg_0, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
    vars->mpe->nativeCodeCache.X86Emit_MOVQMR(x86Reg::x86Reg_mm2, src2RegReadBaseReg_2, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp+8);
    vars->mpe->nativeCodeCache.X86Emit_MOVQMR(x86Reg::x86Reg_mm3, src1RegReadBaseReg_2, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp+8);
    vars->mpe->nativeCodeCache.X86Emit_PANDRR(x86Reg::x86Reg_mm0, x86Reg::x86Reg_mm4);
    vars->mpe->nativeCodeCache.X86Emit_PANDRR(x86Reg::x86Reg_mm1, x86Reg::x86Reg_mm4);
    vars->mpe->nativeCodeCache.X86Emit_PANDRR(x86Reg::x86Reg_mm2, x86Reg::x86Reg_mm4);
    vars->mpe->nativeCodeCache.X86Emit_PANDRR(x86Reg::x86Reg_mm3, x86Reg::x86Reg_mm4);
    vars->mpe->nativeCodeCache.X86Emit_PADDRR(x86Reg::x86Reg_mm0, x86Reg::x86Reg_mm1);
    vars->mpe->nativeCodeCache.X86Emit_PADDRR(x86Reg::x86Reg_mm2, x86Reg::x86Reg_mm3);
    vars->mpe->nativeCodeCache.X86Emit_MOVQRM(x86Reg::x86Reg_mm0, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp);
    vars->mpe->nativeCodeCache.X86Emit_MOVQRM(x86Reg::x86Reg_mm2, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp+8);
    vars->bUsesMMX = true;
  }
  else
  {
    vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_eax, src2RegReadBaseReg_0, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
    vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src1RegReadBaseReg_0, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
    vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ecx, src2RegReadBaseReg_1, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp+4);
    vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_edx, src1RegReadBaseReg_1, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp+4);
    ...
    vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg_2, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp+8);
    vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_edx, src1RegReadBaseReg_2, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp+8);
    vars->mpe->nativeCodeCache.X86Emit_MOVRM(x86Reg::x86Reg_eax, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp);
    vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_eax, src2RegReadBaseReg_3, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp+12);
    ...
    vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ecx, src1RegReadBaseReg_3, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp+12);
    vars->mpe->nativeCodeCache.X86Emit_ANDRR(x86Reg::x86Reg_eax, x86Reg::x86Reg_ebp);
    vars->mpe->nativeCodeCache.X86Emit_ANDRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ebp);
    vars->mpe->nativeCodeCache.X86Emit_ANDRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_ebp);
    vars->mpe->nativeCodeCache.X86Emit_ANDRR(x86Reg::x86Reg_edx, x86Reg::x86Reg_ebp);
    vars->mpe->nativeCodeCache.X86Emit_ADDRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_edx);
    ...
    vars->mpe->nativeCodeCache.X86Emit_MOVRM(x86Reg::x86Reg_eax, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp+12);
  }
}
  ...
  if(src2RegIndex != src1RegIndex)
  {
    if( ((src1RegReadBaseReg_0 == src1RegReadBaseReg_1) && (src1RegReadBaseReg_2 == src1RegReadBaseReg_3)) &&
        ((src2RegReadBaseReg_0 == src2RegReadBaseReg_1) && (src2RegReadBaseReg_2 == src2RegReadBaseReg_3)) )
      {
        ...
        vars->mpe->nativeCodeCache.X86Emit_PANDRR(x86Reg::x86Reg_mm2, x86Reg::x86Reg_mm4);
        vars->mpe->nativeCodeCache.X86Emit_PANDRR(x86Reg::x86Reg_mm3, x86Reg::x86Reg_mm4);
        vars->mpe->nativeCodeCache.X86Emit_PSUBDRR(x86Reg::x86Reg_mm0, x86Reg::x86Reg_mm1);
        vars->mpe->nativeCodeCache.X86Emit_PSUBDRR(x86Reg::x86Reg_mm2, x86Reg::x86Reg_mm3);
        vars->mpe->nativeCodeCache.X86Emit_MOVQRM(x86Reg::x86Reg_mm0, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp);
        vars->mpe->nativeCodeCache.X86Emit_MOVQRM(x86Reg::x86Reg_mm2, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp+8);
        vars->bUsesMMX = true;
      }
      else
      {
        ...
        vars->mpe->nativeCodeCache.X86Emit_ANDRR(x86Reg::x86Reg_edx, x86Reg::x86Reg_ebp);
        vars->mpe->nativeCodeCache.X86Emit_SUBRR(x86Reg::x86Reg_eax, x86Reg::x86Reg_ebx);
        vars->mpe->nativeCodeCache.X86Emit_SUBRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_edx);
        vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg_2, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp+8);
        vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_edx, src1RegReadBaseReg_2, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp+8);
        vars->mpe->nativeCodeCache.X86Emit_MOVRM(x86Reg::x86Reg_eax, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp);
        vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_eax, src2RegReadBaseReg_3, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp+12);
        ...
        vars->mpe->nativeCodeCache.X86Emit_ANDRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_ebp);
        vars->mpe->nativeCodeCache.X86Emit_ANDRR(x86Reg::x86Reg_edx, x86Reg::x86Reg_ebp);
        vars->mpe->nativeCodeCache.X86Emit_SUBRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_edx);
        vars->mpe->nativeCodeCache.X86Emit_SUBRR(x86Reg::x86Reg_eax, x86Reg::x86Reg_ecx);
        vars->mpe->nativeCodeCache.X86Emit_MOVRM(x86Reg::x86Reg_ebx, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp+8);
        vars->mpe->nativeCodeCache.X86Emit_MOVRM(x86Reg::x86Reg_eax, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp+12);
    }
  }
...
void Emit_ANDScalar(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_ANDMR(x86Reg::x86Reg_ebx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
  if(vars->scalarRegOutDep)
  {
    vars->mpe->nativeCodeCache.X86Emit_MOVRM(x86Reg::x86Reg_ebx, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp);
  }
...
void Emit_ANDImmediateShiftScalar(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ecx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_MOVIR(src1Imm, x86Reg::x86Reg_ebx);
  vars->mpe->nativeCodeCache.X86Emit_MOVIR(64,x86Reg::x86Reg_edx);
  vars->mpe->nativeCodeCache.X86Emit_ANDIR(0x3F, x86Reg::x86Reg_ecx);
  vars->mpe->nativeCodeCache.X86Emit_SUBRR(x86Reg::x86Reg_edx, x86Reg::x86Reg_ecx);
  ...
  if(vars->miscRegOutDep & DEPENDENCY_FLAG_NVZ)
  {
    ...
    if(vars->miscRegOutDep & DEPENDENCY_FLAG_N)
    {
      vars->mpe->nativeCodeCache.X86Emit_SETSR(x86Reg::x86Reg_dh);
    }
  ...
  if(vars->miscRegOutDep & DEPENDENCY_FLAG_N)
  {
    vars->mpe->nativeCodeCache.X86Emit_SHLIR(x86Reg::x86Reg_dh, 3);
    vars->mpe->nativeCodeCache.X86Emit_ORRR(x86Reg::x86Reg_al, x86Reg::x86Reg_dh);
  }
...
void Emit_ANDScalarShiftLeftImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_SHLIR(x86Reg::x86Reg_ecx, src2Imm);
...
void Emit_ORImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_ORIR(src1Imm, x86Reg::x86Reg_ebx);
  if(vars->scalarRegOutDep)
  {
    vars->mpe->nativeCodeCache.X86Emit_MOVRM(x86Reg::x86Reg_ebx, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp);
  }
...
void Emit_ORScalar(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_ORMR(x86Reg::x86Reg_ebx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
  if(vars->scalarRegOutDep)
  {
    vars->mpe->nativeCodeCache.X86Emit_MOVRM(x86Reg::x86Reg_ebx, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp);
  }
...
void Emit_EORImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_XORIR(src1Imm, x86Reg::x86Reg_ebx);
  if(vars->scalarRegOutDep)
  {
    vars->mpe->nativeCodeCache.X86Emit_MOVRM(x86Reg::x86Reg_ebx, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp);
  }
...
void Emit_EORScalar(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_XORMR(x86Reg::x86Reg_ebx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
  if(vars->scalarRegOutDep)
  {
    vars->mpe->nativeCodeCache.X86Emit_MOVRM(x86Reg::x86Reg_ebx, destRegWriteBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp);
  }
...
void Emit_ADDImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_ADDIR(src1Imm, x86Reg::x86Reg_ebx);
...
void Emit_ADDScalarShiftLeftImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ecx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_SHLIR(x86Reg::x86Reg_ecx, src2Imm);
  vars->mpe->nativeCodeCache.X86Emit_ADDRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ecx);
...
void Emit_ADDScalarShiftRightImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, destRegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, destRegDisp);
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ecx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_SARIR(x86Reg::x86Reg_ecx, src2Imm);
  vars->mpe->nativeCodeCache.X86Emit_ADDRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ecx);
...
void Emit_SUBImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_SUBIR(src1Imm, x86Reg::x86Reg_ebx);
...
void Emit_SUBScalar(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_SUBMR(x86Reg::x86Reg_ebx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
...
void Emit_SUBImmediateReverse(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVIR(src2Imm, x86Reg::x86Reg_ebx);
  vars->mpe->nativeCodeCache.X86Emit_SUBMR(x86Reg::x86Reg_ebx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
...
void Emit_SUBScalarShiftLeftImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ecx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_SHLIR(x86Reg::x86Reg_ecx, src2Imm);
  vars->mpe->nativeCodeCache.X86Emit_SUBRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ecx);
...
void Emit_ROL(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_ROLIR(x86Reg::x86Reg_ebx, src1Imm);
...
void Emit_AS(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_ANDIR(0x3F, x86Reg::x86Reg_ecx);
  vars->mpe->nativeCodeCache.X86Emit_SUBRR(x86Reg::x86Reg_edx, x86Reg::x86Reg_ecx);
  vars->mpe->nativeCodeCache.X86Emit_MOVRR(x86Reg::x86Reg_ebp, x86Reg::x86Reg_ebx);
  ...
  if(vars->miscRegOutDep & DEPENDENCY_FLAG_C)
  {
    vars->mpe->nativeCodeCache.X86Emit_SHLIR(x86Reg::x86Reg_ebp, 1);
  ...
  if(vars->miscRegOutDep & DEPENDENCY_FLAG_C)
  {
    vars->mpe->nativeCodeCache.X86Emit_SHRIR(x86Reg::x86Reg_ebp, 30);
    vars->mpe->nativeCodeCache.X86Emit_ANDIR(CC_ALU_CARRY, x86Reg::x86Reg_ebp);
  }
  ...
  if(vars->miscRegOutDep & DEPENDENCY_FLAG_C)
  {
    vars->mpe->nativeCodeCache.X86Emit_ORRR(x86Reg::x86Reg_eax, x86Reg::x86Reg_ebp);
  }
...
void Emit_ASL(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_MOVRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_ebx);
  vars->mpe->nativeCodeCache.X86Emit_SHLIR(x86Reg::x86Reg_ebx, src1Imm);
  ...
  if(vars->miscRegOutDep & DEPENDENCY_FLAG_NVCZ)
  {
    ...
    if(vars->miscRegOutDep & DEPENDENCY_FLAG_C)
    {
      vars->mpe->nativeCodeCache.X86Emit_SHRIR(x86Reg::x86Reg_ecx, 30);
      vars->mpe->nativeCodeCache.X86Emit_ANDIR(CC_ALU_CARRY, x86Reg::x86Reg_ecx);
    }
...
void Emit_ASR(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_MOVRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_ebx);
  vars->mpe->nativeCodeCache.X86Emit_SARIR(x86Reg::x86Reg_ebx, src1Imm);
  ...
  if(vars->miscRegOutDep & DEPENDENCY_FLAG_NVCZ)
  {
    ...
    if(vars->miscRegOutDep & DEPENDENCY_FLAG_C)
    {
      vars->mpe->nativeCodeCache.X86Emit_SHLIR(x86Reg::x86Reg_ecx, 1);
      vars->mpe->nativeCodeCache.X86Emit_ANDIR(CC_ALU_CARRY, x86Reg::x86Reg_ecx);
    }
...
void Emit_LSR(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVMR(x86Reg::x86Reg_ebx, src2RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src2RegDisp);
  vars->mpe->nativeCodeCache.X86Emit_MOVRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_ebx);
  vars->mpe->nativeCodeCache.X86Emit_SHRIR(x86Reg::x86Reg_ebx, src1Imm);
...
void Emit_ADDWCImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_RCRIR(x86Reg::x86Reg_ecx, 2);
  vars->mpe->nativeCodeCache.X86Emit_ADCIR(src1Imm, x86Reg::x86Reg_ebx);
...
void Emit_ADDWCScalar(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_eax);
  vars->mpe->nativeCodeCache.X86Emit_RCRIR(x86Reg::x86Reg_ecx, 2);
  vars->mpe->nativeCodeCache.X86Emit_ADCMR(x86Reg::x86Reg_ebx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
...
void Emit_ADDWCScalarShiftLeftImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_RCRIR(x86Reg::x86Reg_edx, 2);
  vars->mpe->nativeCodeCache.X86Emit_ADCRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ecx);
...
void Emit_SUBWCImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_eax);
  vars->mpe->nativeCodeCache.X86Emit_RCRIR(x86Reg::x86Reg_ecx, 2);
  vars->mpe->nativeCodeCache.X86Emit_SBBIR(src1Imm, x86Reg::x86Reg_ebx);
...
void Emit_SUBWCImmediateReverse(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVRR(x86Reg::x86Reg_ecx, x86Reg::x86Reg_eax);
  vars->mpe->nativeCodeCache.X86Emit_RCRIR(x86Reg::x86Reg_ecx, 2);
  vars->mpe->nativeCodeCache.X86Emit_SBBMR(x86Reg::x86Reg_ebx, src1RegReadBaseReg, x86IndexReg::x86IndexReg_none, x86ScaleVal::x86Scale_1, src1RegDisp);
...
void Emit_SUBWCScalarShiftLeftImmediate(EmitterVariables * const vars, const Nuance &nuance)
{
  ...
  vars->mpe->nativeCodeCache.X86Emit_MOVRR(x86Reg::x86Reg_edx, x86Reg::x86Reg_eax);
  vars->mpe->nativeCodeCache.X86Emit_RCRIR(x86Reg::x86Reg_edx, 2);
  vars->mpe->nativeCodeCache.X86Emit_SBBRR(x86Reg::x86Reg_ebx, x86Reg::x86Reg_ecx);
