...
void NativeCodeCache::X86Emit_ADDMR(const x86Reg regDest, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
  X86Emit_Group1MR(regDest, base, index, scale, disp, 0);
}

void NativeCodeCache::X86Emit_ADDIR(const intptr_t imm, const x86Reg regDest)
{
...
void NativeCodeCache::X86Emit_ORRM(const x86Reg regSrc, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
  X86Emit_Group1RM(regSrc, base, index, scale, disp, 1);
}

void NativeCodeCache::X86Emit_ORMR(const x86Reg regDest, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
  X86Emit_Group1MR(regDest, base, index, scale, disp, 1);
}

void NativeCodeCache::X86Emit_ORIR(const intptr_t imm, const x86Reg regDest)
{
  X86Emit_Group1IR(imm, regDest, 1);
}

void NativeCodeCache::X86Emit_ORIM(const int32 imm, const x86MemPtr ptrType, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
...
void NativeCodeCache::X86Emit_ADCMR(const x86Reg regDest, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
  X86Emit_Group1MR(regDest, base, index, scale, disp, 2);
}

void NativeCodeCache::X86Emit_ADCIR(const intptr_t imm, const x86Reg regDest)
{
...
void NativeCodeCache::X86Emit_SBBMR(const x86Reg regDest, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
  X86Emit_Group1MR(regDest, base, index, scale, disp, 3);
}

void NativeCodeCache::X86Emit_SBBIR(const intptr_t imm, const x86Reg regDest)
{
...
void NativeCodeCache::X86Emit_ANDRM(const x86Reg regSrc, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
  X86Emit_Group1RM(regSrc, base, index, scale, disp, 4);
}

void NativeCodeCache::X86Emit_ANDMR(const x86Reg regDest, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
  X86Emit_Group1MR(regDest, base, index, scale, disp, 4);
}

void NativeCodeCache::X86Emit_ANDIR(const intptr_t imm, const x86Reg regDest)
{
  X86Emit_Group1IR(imm, regDest, 4);
}

void NativeCodeCache::X86Emit_ANDIM(const int32 imm, const x86MemPtr ptrType, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
...
void NativeCodeCache::X86Emit_SUBMR(const x86Reg regDest, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
  X86Emit_Group1MR(regDest, base, index, scale, disp, 5);
}

void NativeCodeCache::X86Emit_SUBIR(const intptr_t imm, const x86Reg regDest)
{
...
void NativeCodeCache::X86Emit_XORMR(const x86Reg regDest, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
  X86Emit_Group1MR(regDest, base, index, scale, disp, 6);
}

void NativeCodeCache::X86Emit_XORIR(const intptr_t imm, const x86Reg regDest)
{
...
void NativeCodeCache::X86Emit_CMPIR(const intptr_t imm, const x86Reg regDest)
{
...
void NativeCodeCache::X86Emit_SHLRM(const x86MemPtr ptrType, const uintptr_t base, const x86IndexReg index, const x86ScaleVal scale, const int32 disp)
{
