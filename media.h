...
#define HAVE_BOOT_MEDIA (1u<<((uint32)eMedia::MEDIA_BOOT_DEVICE - (uint32)eMedia::MEDIA_BOOT_DEVICE))
#define HAVE_DVD_MEDIA (1u<<((uint32)eMedia::MEDIA_DVD - (uint32)eMedia::MEDIA_BOOT_DEVICE))
#define HAVE_REMOTE_MEDIA (1u<<((uint32)eMedia::MEDIA_REMOTE - (uint32)eMedia::MEDIA_BOOT_DEVICE))
#define HAVE_FLASH_MEDIA (1u<<((uint32)eMedia::MEDIA_FLASH - (uint32)eMedia::MEDIA_BOOT_DEVICE))
