...
uint32 Print_ECU_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
...
uint32 Print_Halt(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[] = "halt";
  sprintf(buffer,"%s%s",tempStr, bNewline ? "\n" : "");
  return strlen(tempStr) + (bNewline ? 1 : 0);
...
uint32 Print_BRAAlways(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_BRAAlways_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_BRAConditional(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_BRAConditional_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JMPAlwaysIndirect(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JMPAlwaysIndirect_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JMPConditionalIndirect(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JMPConditionalIndirect_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JSRAlways(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JSRAlways_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JSRConditional(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JSRConditional_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JSRAlwaysIndirect(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JSRAlwaysIndirect_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JSRConditionalIndirect(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_JSRConditionalIndirect_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_RTSAlways(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[] = "rts";
  sprintf(buffer,"%s%s",tempStr, bNewline ? "\n" : "");
  return strlen(tempStr) + (bNewline ? 1 : 0);
...
uint32 Print_RTSAlways_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
...
uint32 Print_RTSConditional(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_RTSConditional_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_RTI1Conditional(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_RTI1Conditional_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_RTI2Conditional(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
...
uint32 Print_RTI2Conditional_NOP(char *buffer, Nuance &nuance, bool bNewline)
{
  char tempStr[512];
